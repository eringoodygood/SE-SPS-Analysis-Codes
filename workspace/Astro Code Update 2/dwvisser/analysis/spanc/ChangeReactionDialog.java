...
ChangeListener {
    ...
    private void buildGUI(){
        ...
        _ebeam.setText(Double.toString(reaction.getBeamEnergy()));
        temp = new JPanel(new GridLayout(1,0)); center.add(temp);
        temp.add(new JLabel("B-field [kG]")); temp.add(_bfield);
        _bfield.setText(Double.toString(reaction.getMagneticField()));
        temp = new JPanel(new GridLayout(1,0)); center.add(temp);
    ...
    private void modifyReaction() throws NuclearException {
        ...
        reaction.setValues(beam, targetN, projectile, ebeam,
