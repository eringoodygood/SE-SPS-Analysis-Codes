...
import net.sourceforge.nukesim.analysis.GJENice;
...
public final class PolynomialFitErrY {
	 ...
	 * @throws net.sourceforge.nukesim.statistics.StatisticsException if there's a 
	 * problem
	 */
	public UncertainNumber calculateY(UncertainNumber ux)
		throws net.sourceforge.nukesim.statistics.StatisticsException {
		final double curveError =
			net.sourceforge.nukesim.statistics.MiscMath.findOneSigmaT(dof)
				* Math.sqrt(
					MSE
						* (1.0 / x.length
