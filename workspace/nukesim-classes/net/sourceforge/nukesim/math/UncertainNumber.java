...
public class UncertainNumber implements Serializable {
	...
	public String toPlusMinusString() {
		...
		if (error > 0.0) {
			...
			fval.setMaximumFractionDigits(temp);
			fval.setMinimumIntegerDigits(1);
			return fval.format(value) + " \u00b1 " + fval.format(error);
		} else { //=0.0
			return String.valueOf(value);
		}
	}
	...
	private String abbreviatedError() {
		final int threeDigits = firstThreeErrorDigits();
		String rval = "10";
	...
	public static void main(String[] args) {
		...
		final UncertainNumber u=new UncertainNumber(709.8, .950);
		System.out.println(u+"\t"+u.plusMinusString());
	}
}
