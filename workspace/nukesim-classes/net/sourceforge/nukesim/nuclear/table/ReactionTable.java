...
import net.sourceforge.nukesim.math.*;
 ...
 * @version 1.0
 */
public class ReactionTable extends JTable implements MassChangeListener{
	...
	public void massChanged(){
		for (int i=0; i<3; i++){
			setValueAt(((Nucleus)getValueAt(i, 1)).toString(), i, 1);
		}
	}
}
