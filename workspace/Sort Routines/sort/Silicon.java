 ...
 */
public class Silicon extends SortRoutine {
...
//	***check the addresses for these events***
	...
	cnafCommands.init(1,30,3,26);	    //Sets the crate I (Inhibit)
	...
	idSurfBarr  = cnafCommands.eventRead(1,3,0,0);      //read beam monitor	    (slot 9 channel 0)
