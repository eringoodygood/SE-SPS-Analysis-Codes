...
public class UNC3 extends SortRoutine {
    ...
    public void initialize() throws Exception {
     ...
     //gate on Front Cathode
      ...
      hFrntPsnG5 = new Histogram("FrontPosnG5", HIST_1D_INT,  2048, 
            "Front Position - Fr-An Fr-Snt Fr-Ca Snt-Ca Ca-An","Front Position","Counts");
     ...
     //gate on Front Anode
      ...
      gFrntSntr      =new Gate("Fr-Sn", hFrntSntr);
  ...
  // gated on all 2 gate above   presort
