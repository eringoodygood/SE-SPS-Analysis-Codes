...
public class SplitPoleOffscint extends SortRoutine {
...
//    Histogram hRearPsn;
  ...
  //gate by scintillator vs. cathode
   ...
   /*  hRearPH = new Histogram("RearPvsHeight ", HIST_2D_INT, 256,
    ...
    /*  hFrntPRearP = new Histogram("FrontRear  ", HIST_2D_INT, 256,
     ...
     //gate on Front Cathode
      ...
      hFrntCthdGSC = new Histogram("FrntCthdGSC", HIST_2D_INT, 256,
                                   "Anode vs Cathode- FrCa gate",
                                   "Cathode", "Anode");
...
//      gFrntRear   =new Gate("Fw-Rw", hFrntPRearP);      //gate on Front Rear
      ...
      gSntrCthd   =new Gate("Sc-Ca", hSntrCthd);   //gate on scintillator cathode
      ...
      hFrntCthdGSC.addGate(gSntrCthd);
      //scalers
...
//      int eRHgh   =dataEvent[idRearHgh];
  ...
  // gated on all 2 gate above (GCSF is no longer GCSF)
