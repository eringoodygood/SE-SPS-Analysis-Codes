 ...
 * modified June 99 by Rachel Lewis
...
public class SplitPoleOnAnodeCathode extends SortRoutine {
    ...
    //front wire gate on all
    Histogram hFrntGCSF;
    Histogram hFrntGAll;

    //front wire gated on All compressed
