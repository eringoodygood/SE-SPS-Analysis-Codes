 ...
 */
public class SplitPoleStudents extends SortRoutine {
...
//  ***check the addresses for these events***
  ...
  hFrntAndeGCA=new Histogram("FrontAnodeGCA", HIST_2D_INT,  256, "Anode vs Front Position - CaAn gate","Front Position", "Anode");
  hFrntCthdGCA=new Histogram("FrontCathodeGCA", HIST_2D_INT,  256, "Cathode vs Front Position - CaAn gate","Front Position","Cathode");

  //gate on Front Wire Cathode
  hCthdAndeGFC=new Histogram("CathodeAndeGFC", HIST_2D_INT,  256, "Cathode vs Anode - FwCa gate", "Anode","Cathode");
  hFrntAndeGFC=new Histogram("FrontAndeGFC", HIST_2D_INT,  256, "Anode vs Front Position - FwCa gate","Front Position", "Anode");

  //gate on Front Wire Anode
  hCthdAndeGFA=new Histogram("CathodeAndeGFA", HIST_2D_INT,  256, "Cathode vs Anode - FwAn gate","Anode","Cathode");
  hFrntCthdGFA=new Histogram("FrontCathodeGFA", HIST_2D_INT,  256, "Cathode vs Front Position - FwAn gate ","Front Position","Cathode");


  //gate on 4 gates
  hFrntGAll   =new Histogram("FrontGAll    ", HIST_1D_INT, 2048, "Front Position - CaAn,FwCa,FwAn,FwRw gates");
  hRearGAll   =new Histogram("RearGAll    ", HIST_1D_INT, 2048, "Rear Position - CaAn,FwCa,FwAn,FwRw gates");
  hcFrntGAll  =new Histogram("FrontGAllcmp ", HIST_1D_INT, 512, "Front Position comp - CaAn,FwCa,FwAn,FwRw gates");
  hcRearGAll  =new Histogram("RearGAllcmp ", HIST_1D_INT, 512, "Rear Position comp - CaAn,FwCa,FwAn,FwRw gates");
  ...
  gFrntAnde   =new Gate("Fw-An", hFrntAnde);          //gate on Front Scintillator
  ...
  if ( gFrntCthd.inGate(ecFPsn,ecCthd) ){
   ...
   // gate on Front Wire Position vs Anode  
