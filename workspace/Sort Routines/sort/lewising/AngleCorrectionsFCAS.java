...
//NEW        setEventSize(NUM_PARAMETERS);
        ...
        for (int i=0;i<NUM_GATES;i++){
            ...
            hAndeTheta[i]  =new Histogram("AndeThet"+i, HIST_2D, 256,  " Scintillator vs. Theta - Peak"+i,"Theta","Scintillator");
            hAndeThNew[i]  =new Histogram("AndeThNew"+i, HIST_2D, 256,  " Scintillator  vs. Theta Corrected - Peak"+i,"Theta","Scintillator");
    ...
    public void sort(int [] dataEvent) throws Exception {
        ...
        if ((gAndeCthd.inGate(ecCthd,ecAnde)) &&
