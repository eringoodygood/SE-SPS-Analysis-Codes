 ...
 */
public class jps extends SortRoutine {
    ...
    Histogram hCthdAndeGFS;
    
    //front and rear wire gate on all    
    Histogram hFrntGAll;
    Histogram hRearGAll;
    
    //gated on Scintillator, Cathode and Anode to check kinematic focus
    Histogram hFrntRearGSCA;
	...
	hCthdAndeGFS = new Histogram("CathodeAnodeGFS ", HIST_2D, 256, "Cathode vs Anode - FwSc gate ", "cathode", "anode");
	...
	//gate on scintillator, cathode and anode - check focus
	hFrntRearGSCA =new Histogram("FrontRearGSCA   ", HIST_2D, 2048, " Front vs Rear Position, gated on Scint, Cath, Anode ", "front position", "rear position"); 
	...
	gCthdAnde   =new Gate("Ca-An", hCthdAndeGFS);
