 ...
 * last modified September 2000 by Dale Visser and Rachel Lewis
 */
public class SplitPoleAlpha3 extends SortRoutine {
    ...
    public void sort(int [] dataEvent) throws Exception {
		...
		int ecFPsn=eFPsn>>TWO_D_FACTOR;
  		...
  		// gate on all 3 gates above and the Front wire vs Rear Wire and the 2-Scintillator
  		if (( gScint1Scint2.inGate(ecSntr1,ecSntr2) )&&
