 ...
 */
public class SplitPoleBeta extends SortRoutine {
    ...
    public void initialize() throws Exception {
        ...
        hFrntTDC = new Histogram("FrntTDC",HIST_1D_INT,2*ADC_CHANNELS,"Front Spectrum from TDC's");
        hRearTDC=new Histogram("RearTDC",HIST_1D_INT,2*ADC_CHANNELS,"Rear Spectrum from TDC's");
    ...
    public void sort(int [] dataEvent) throws Exception {
        ...
        int eFrontR = dataEvent[idFrontR];
        int eFrontL = dataEvent[idFrontL];
        int eRearR = dataEvent[idRearR];
        int eRearL = dataEvent[idRearL];
        
        int eFrntTDC = idFrontL /*stop*/ - idFrontR /*start*/ + ADC_CHANNELS; //to guarantee 0-2*ADC_CHANNELS - 1 range
        int eRearTDC = idRearL /*stop*/ - idRearR /*start*/ + ADC_CHANNELS; //to guarantee 0-2*ADC_CHANNELS - 1 range
        ...
        hFrntPsn.inc(eFPsn);
        hRearPsn.inc(eRPsn);
        hFrntTDC.inc(eFrntTDC);
        hRearTDC.inc(eRearTDC);
        hFrntHgh.inc(eFHgh);
        hRearHgh.inc(eRHgh);
        hSilicon.inc(eSil);
        hNaI1.inc(eNaI1);
