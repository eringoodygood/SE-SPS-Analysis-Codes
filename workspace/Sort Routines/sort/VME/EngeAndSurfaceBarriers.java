 ...
 */
public class EngeAndSurfaceBarriers extends SortRoutine {
    ...
    public void initialize() throws Exception {
        ...
        idSilicon1=vmeMap.eventParameter(9, ADC_BASE, 8, THRESHOLDS);
    ...
    public void sort(int [] dataEvent) throws Exception {
        ...
        boolean bSC = gSntrCthd.inGate(ecSntr,ecCthd);// gate on Scintillator vs Cathode
        boolean bFC = gFrntCthd.inGate(ecFPsn,ecCthd);// gate on Front Wire Position vs Cathode
        boolean bFS = gFrntSntr.inGate(ecFPsn,ecSntr);// gate on Front Wire Position vs Scintillator
        boolean bPID = bSC && bFC && bFS;//all particle ID gates
