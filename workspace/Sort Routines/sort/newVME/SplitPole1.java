 ...
 * @since 26 July 2001
 */
public class SplitPole1 extends SortRoutine {
    //VME properties
static final int [] ADC_BASE = {0x20000000,0x20010000,0x20020000};
    ...
    // ungated spectra
    Histogram hCthd,hAnde,hAnde2,hSntr1,hSntr2,hSntrSum, hFrntPsn, hRearPsn;
    Histogram hTheta, hFrntGTheta;       // rear - front, front gated by theta
    ...
    Histogram hSntrAnde, hSntrAnde2;
    //Histogram hAndeADC2vsADC1;

    Gate  gCthd, gPeak, gTheta;     //gates 1 d
    ...
    int idCthd, idAnde, idAnde2, idScintR, idScintL, idFrntPsn, idRearPsn, idFrntHgh,
    ...
    public void initialize() throws Exception {
        ...
        idAnde2=vmeMap.eventParameter(2, ADC_BASE[0], 11, THRESHOLDS);
        ...
        "Anode Raw");
        hAnde2     =new Histogram("Anode2       ", HIST_1D_INT, ADC_CHANNELS,
        "Anode2 Raw");
        ...
        "Front Wire Position");
        hFrntGTheta    =new Histogram("FrontGTheta    ", HIST_1D_INT, ADC_CHANNELS,
        "Front Wire Position - theta gated");
        hTheta      =new Histogram("Theta        ", HIST_1D_INT, ADC_CHANNELS,
        "Theta");
        ...
        hCthdAnde2  =new Histogram("CathodeAnode2  ", HIST_2D_INT,  TWO_D_CHANNELS, "Cathode vs Anode2 ","Cathode","Anode2");
        ...
        hSntrAnde2  =new Histogram("ScintAnode2  ", HIST_2D_INT,  TWO_D_CHANNELS, "Anode2 vs Scintillator","Scintillator","Anode2");
        ...
        /*hAndeADC2vsADC1 = new Histogram("AndeADC2vsADC1", HIST_2D_INT,TWO_D_CHANNELS,
        "Anode: ADC 2 value vs. ADC 1 value", "ADC 1", "ADC 2");*/
        //hDebug = new Histogram("Debug", HIST_1D_INT, 8, "Debug Word");
        
        // gates 1d
        gCthd   =new Gate("Counts", hCthd);
        gPeak   =new Gate("Peak", hFrntGAll);
        gTheta  =new Gate("Theta",hTheta);
    ...
    public void sort(int [] dataEvent) throws Exception {
        ...
        //hAndeADC2vsADC1.inc(ecAnde,eAndeADC2>>TWO_D_FACTOR);
        ...
        hCthdAnde2.inc(ecCthd,eAnde2>>TWO_D_FACTOR);
        hSntrAnde.inc(ecSntr,eAnde>>TWO_D_FACTOR);
        hSntrAnde2.inc(ecSntr,eAnde2>>TWO_D_FACTOR);
        ...
        boolean bTheta = gTheta.inGate(eTheta);

        if (bTheta) {// gate on Theta
            hFrntGTheta.inc(eFPsn);
        }
