 ...
 * @since 26 July 2001
 * 
 * Modified May 07 by Catherine Deibel for YSLA calibrations done after apr07 27Al(3He,t) run for energy and time
 */
    public class SplitPoleYLSA_TAJ_scint2_cal_may07 extends SortRoutine {
//VME properties
...
//det 0 
	1.001,1.009,1.027,1.003,1.005,0.944,1.008,1.007,
    1.044,1.009,0.996,1.043,1.067,1.017,1.042,0.994, 
//det 1
	0.941,1.056,1.020,0.933,1.026,1.015,1.024,0.981,
    1.059,1.022,1.000,1.010,1.086,1.061,1.066,0.979,
//det 2
	1.170,2.279,1.274,1.256,1.270,1.202,1.245,1.265,
	1.290,1.270,1.263,1.260,1.310,1.255,1.285,1.208,
//det 3
	1.263,1.233,1.247,1.318,1.307,1.271,1.222,1.246,
    1.278,1.296,1.257,1.355,1.291,1.328,1.225,1.276,
//det4
    0.980, 1.014, 1.139, 1.010, 1.029, 1.043, 1.035, 1.004, 
    1.040, 1.009, 1.060, 1.064, 1.083, 1.053, 1.061, 0.999};

	static final double [] Offsets={
//det0			
	90,113,121,113,146,288,105,88,
	112,97,106,122,115,107,85,114,
//det1	
	81,91,131,124,128,127,136,122,
    115,122,116,108,134,100,114,104,
//det2
	114,115,116,125,103,101,96,115,
    124,96,108,120,121,58,137,129,
//det3	
	131,140,130,149,130,132,141,115,
    126,105,132,126,146,121,148,111,
//det4	
    43,58,123,131,113,94,121,103,  
    125,119,148,112,128,123,79,101};
    
	static final double [] T_Gains={
//	  det 0 
		1.014, 1.026, 1.040, 1.031, 1.018, 1.016, 1.019, 1.047, 
		1.050, 1.034, 1.052, 1.025, 1.022, 1.047, 1.019, 1.012, 
//	  det 1
		.965, .968, .959, .954, .951, .929, .998, .954, 
		.942, .946, .930, .959, 0.938, .940, .937, .942,
//	  det 2
		.952, .956, .944, .959, .934, .947, .934, .942, 
		.952, .945, .944, .954, .934, .951, .929, .961,
//	  det 3
		1.000, 1.002, 1.005, 1.003, .992, .992, 995, .984, 
		1.011, 1.005, 1.015, 1.012, .996, 1.000, .994, .989,
//	  det4
		1.003, .986, 1.021, 1.000, 1.000, .986, 1.005, 1.000, 
		1.005, 1.017, 1.028, .987, 1.010, .999, 1.012, 1.006};

	static final double [] T_Offsets={
//	 det0
		468, 460, 479, 447, 456, 448, 463, 513, 
		444, 416, 452, 395, 360, 415, 383, 409,
//	det 1
		377, 408, 374, 386, 342, 319, 464, 370, 
		368, 374, 349, 367, 335, 358, 330, 319,
//	det 2
		407, 344, 356, 382, 349, 366, 357, 355,
		421, 336, 377, 368, 363, 352, 344, 388, 
//	det 3
		466, 471, 485, 472, 458, 441, 496, 444, 
		502, 528, 527, 505, 457, 493, 482, 443,
// 	det 4
		-299, 113, 517, 487, 433, 457, 488, 480,
		496, 492, 565, 497, 500, 477, 517, 500};

	/*	static final double [] T_Offsets={
//	  det0			
		767, 760, 779, 746, 755, 747, 762, 813,  
		743, 716, 751, 694, 660, 715, 683, 709,
//	  det1	
		676, 707, 673, 685, 642, 618, 764, 669, 
		667, 673, 649, 667, 634, 657, 629, 618,
//	  det2
		706, 644, 655, 682, 649, 665, 656, 654,  
		721, 635, 677, 667, 663, 651, 643, 687,
//	  det3	
		766, 770, 784, 772, 758, 740, 795, 743, 
		801, 828, 827, 804, 757, 792, 781, 742,
//	  det4	
		0, 413, 816, 786, 732, 756, 788, 780,  
		796, 792, 865, 797, 799, 776, 816, 799};*/
/*	from nov06	
//		det0			
...
//	Histogram hEvsChBroad;
	...
	Histogram hFPGAll_gs_m1, hFPGAll_ms_m1, hFPGAll_ex_m1;
	Histogram hFPGAll_St_m1_bck;
...
//		hEsilVsFP_peak   = new Histogram("EsilVsFP_peak",                HIST_2D_INT, TWO_D_CHANNELS, TWO_D_CHANNELS,                    "E (YLSA) vs. Focal Plane Position gated on peak in FP",             "QBrho [channels]",   "YLSA Energy");
		hEsilVsFP_gTime  = new Histogram("EsilVsFP_gTime",               HIST_2D_INT, TWO_D_CHANNELS, TWO_D_CHANNELS,                    "E (YLSA) vs. Focal Plane Position gated on time peak",              "QBrho [channels]",   "YLSA Energy");
		...
		hEsilVsFP_m1     = new Histogram("EsilVsFP_m1",                  HIST_2D_INT, TWO_D_CHANNELS, TWO_D_CHANNELS,                    "E (YLSA) vs. Focal Plane Position, multiplicity=1",                 "QBrho [channels]",   "YLSA Energy");
