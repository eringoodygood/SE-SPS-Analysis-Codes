 ...
 */
public class SplitPoleSiliconTiming extends SortRoutine {
    ...
    int idRearPH;
    int idFlightTime;		// Array position for Flight Time parameter
    int lastEvntAccpt;
...
//	***check the addresses for these events***
	...
	idFlightTime=cnafCommands.eventRead(1,13,7,2);  //read TDC ch 7 & clear all TDC channels 
	...
	hSilicon    =new Histogram("Silicon     ", HIST_1D_INT, 2048, "Silicon Detector");
	hFlightTime =new Histogram("Flight Time ", HIST_1D_INT, 2048, "Time of Flight");
	...
	int eTOF    = dataEvent[idFlightTime];	    	
