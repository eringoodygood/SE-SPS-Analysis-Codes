...
/** OFFLINE sort routine for YLSA coincidence with Enge Spectrometer.
 * This was modified from <CODE>sort.coinc.SPplus3LEDA_v3</CODE>, which
 * was used in the January 2001 test run.
 * @author Dale Visser, Rachel Lewis -- monitors and scalers taken out, writeEvent put in when bGood; gate in cathAnode; scint = average of both sides
 * @since 10 August 01
 */
public class YLSAandEnge_CathMod_1 extends SortRoutine {
    //VME properties
