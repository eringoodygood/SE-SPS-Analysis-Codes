 ...
 * @since 26 July 2001
 */
public class Ne19_monitored extends SortRoutine {
    //VME properties
...
static final int [] TDC_BASE = {0x30000000,0x30010000,0x30020000};
    ...
    public void initialize() throws Exception {
        ...
        for (int i=0; i<NUM_DETECTORS; i++) {
            idBackPlane[i] = vmeMap.eventParameter(8, ADC_BASE[3], i+8, 0);
            ...
            hBackPlane[i]=new Histogram("BackPlane "+i, HIST_1D_INT, ADC_CHANNELS, "Backplane Energy of Detector "+i);
