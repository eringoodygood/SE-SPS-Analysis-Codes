 ...
 * @since 26 July 2001
 */
public class Mg22_presort extends SortRoutine {
    //VME properties
...
static final int [] TDC_BASE = {0x30000000,0x30010000,0x30020000};
    ...
    //offline pre-sort gates
    Gate goodScint, goodFrCa;
    ...
    public void initialize() throws Exception {
        ...
        //offline presort gates
        goodScint = new Gate("goodScint", hSntrSum);
        goodFrCa = new Gate("goodFrCa", hFrntCthd);
    ...
    public void sort(int [] dataEvent) throws Exception {
        ...
        if (goodScint.inGate(eSntr) && goodFrCa.inGate(ecFPsn,ecCthd)){
