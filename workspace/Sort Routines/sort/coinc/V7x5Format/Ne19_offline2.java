 ...
 * @since 26 July 2001
 */
public class Ne19_offline2 extends SortRoutine {
    //VME properties
    ...
    Histogram hFrntNewGAll, hcFrntNewGAll;//corrected FP posn gated on All compressed & time
    ...
    Histogram hEsilVsFP;
    Histogram hRYvsFY; Gate gRYvsFY;
    ...
    DataParameter dp_XTheta, dp_XTheta2, dp_XTheta3,
    dp_XThetaDelta, dp_XTheta2Delta, dp_XTheta3Delta,
    dp_XThetaDelta2, dp_XTheta2Delta2, dp_XTheta3Delta2;
    ...
    Histogram hScintNewVsPosn,hCathNewVsPosn,hCathNewVsScintNew,
    hAndeNewVsCathNew,hAndeNewVsScintNew,hAndeNewVsPosn;
    Gate gScintNewVsPosn, gCathNewVsPosn, gCathNewVsScintNew,
    gAndeNewVsCathNew, gAndeNewVsScintNew, gAndeNewVsPosn;
    Histogram hCathNewVsScintNew_gFC, hCathNewVsScintNew_gFS,
    hAndeNewVsCathNew_g3, hAndeNewVsScintNew_g3, hAndeNewVsPosn_g3;
    Histogram hThetaVsFrontGPID, hThetaVsFront_corr,  hPhiVsFrontGPID,
    hPhiVsFront_corr;
    
    Gate gYvsPsn;
    Gate gThetaVsPsnCorr;
	Histogram hStripDecay;
    ...
    public void initialize() throws Exception {
        ...
        double ebeam = 25.0;
        rk=new ResidualKinematics(25,0,new Nucleus(2,3), new Nucleus(9,19),
        new Nucleus(1,3));
        ...
        hFrntNewGAll   =new Histogram("FrontNewGAll ", HIST_1D_INT, ADC_CHANNELS, "Corrected Front Position - ScCa,FwCa,FwSc,FwRw gates");
        hcFrntNewGAll  =new Histogram("FrNewGAllcmp ", HIST_1D_INT, COMPRESSED_CHANNELS, "Corrected Front Position compressed - ScCa,FwCa,FwSc,FwRw gates");
        hFrntGTime  = new Histogram("FrNGTime    ", HIST_1D_INT, ADC_CHANNELS, "Corrected Front Position - ScCa,FwCa,FwSc,FwRw & time gates");
        hcFrntGTime  =new Histogram("FrontGTimecmp ", HIST_1D_INT, COMPRESSED_CHANNELS, "Corrected Front Position compressed - ScCa,FwCa,FwSc,FwRw & time gates");
        
        CathTheta = new Histogram("CathTheta", HIST_2D_INT, TWO_D_CHANNELS,
        "Theta vs. Cathode", "Cathode", "Theta");
        CathPhi = new Histogram("CathPhi", HIST_2D_INT, TWO_D_CHANNELS,
        "Phi vs. Cathode", "Cathode", "Phi");
        ScintTheta = new Histogram("ScintTheta", HIST_2D_INT, TWO_D_CHANNELS,
        "Theta vs. Scintillator", "Scintillator", "Theta");
        ScintPhi = new Histogram("ScintPhi", HIST_2D_INT, TWO_D_CHANNELS,
        "Phi vs. Scintillator", "Scintillator", "Phi");
        AndeTheta = new Histogram("AndeTheta", HIST_2D_INT, TWO_D_CHANNELS,
        "Theta vs. Anode", "Anode", "Theta");
        AndePhi = new Histogram("AndePhi", HIST_2D_INT, TWO_D_CHANNELS,
        "Phi vs. Anode", "Anode", "Phi");
        PosnTheta = new Histogram("PosnTheta", HIST_2D_INT, TWO_D_CHANNELS,
        "Theta vs. Position", "Position", "Theta");
        
        hScintNewVsPosn = new Histogram("ScintNewVsPosn", HIST_2D_INT,
        TWO_D_CHANNELS,"New Scintillator vs. Position", "Position", "ScintNew");
        hCathNewVsPosn = new Histogram("CathNewVsPosn", HIST_2D_INT,
        TWO_D_CHANNELS,"New Cathode vs. Position", "Position", "CathNew");
        hCathNewVsScintNew = new Histogram("CathNewVsSntrNew", HIST_2D_INT,
        TWO_D_CHANNELS,"New Cathode vs. New Scintillator", "ScintNew",
        "CathNew");
        hAndeNewVsCathNew = new Histogram("AndeNewVsCathNew", HIST_2D_INT,
        TWO_D_CHANNELS,"New Anode vs. New Cathode", "CathNew", "AndeNew");
        hAndeNewVsScintNew = new Histogram("AndeNewVsSntrNew", HIST_2D_INT,
        TWO_D_CHANNELS,"New Anode vs. New Scintillator", "SntrNew", "AndeNew");
        hAndeNewVsPosn = new Histogram("AndeNewVsPosn", HIST_2D_INT,
        TWO_D_CHANNELS,"New Anode vs. Position", "Position", "AndeNew");
        ...
        hCathNewVsScintNew_gFS = new Histogram("CathSntrNew_gFS", HIST_2D_INT,
        TWO_D_CHANNELS,"New Cathode vs. New Scintillator, gated on New FrSc",
        "ScintNew", "CathNew");
        hCathNewVsScintNew_gFS.addGate(gCathNewVsScintNew);
        hCathNewVsScintNew_gFC = new Histogram("CathSntrNew_gFC", HIST_2D_INT,
        TWO_D_CHANNELS,"New Cathode vs. New Scintillator, gated on New FrCa",
        "ScintNew", "CathNew");
        hCathNewVsScintNew_gFC.addGate(gCathNewVsScintNew);
        
        hAndeNewVsCathNew_g3 = new Histogram("AndeCathNew_g3", HIST_2D_INT,
        TWO_D_CHANNELS,
        "New Anode vs. New Cathode, gated on new FrSv, FrCa, ScCa", "CathNew",
        "AndeNew");
        hAndeNewVsCathNew_g3.addGate(gAndeNewVsCathNew);
        hAndeNewVsScintNew_g3 = new Histogram("AndeSntrNew_g3", HIST_2D_INT,
        TWO_D_CHANNELS,
        "New Anode vs. New Scintillator, gated on new FrSv, FrCa, ScCa",
        "SntrNew", "AndeNew");
        hAndeNewVsScintNew_g3.addGate(gAndeNewVsScintNew);
        hAndeNewVsPosn_g3 = new Histogram("AndeNewVsPosn_g3", HIST_2D_INT,
        TWO_D_CHANNELS,"New Anode vs. Position, gated on new FrSv, FrCa, ScCa",
        "Position", "AndeNew");
        hAndeNewVsPosn_g3.addGate(gAndeNewVsPosn);
        hThetaVsFrontGPID = new Histogram("ThetaVsPosnPID",HIST_2D_INT,
        1024,"Theta vs. Position, gated on PID", "Position", "Theta");
        hThetaVsFront_corr = new Histogram("ThetaVsPosnNew",HIST_2D_INT,
        TWO_D_CHANNELS,"Theta vs. Corrected Position, gated on PID", 
        "New Position", "Theta");
		gThetaVsPsnCorr = new Gate("ThetaPsn", hThetaVsFront_corr);
        hPhiVsFrontGPID = new Histogram("PhiVsPosnPID",HIST_2D_INT,
        TWO_D_CHANNELS,"Phi vs. Position, gated on PID", "Position", "Phi");
        hPhiVsFront_corr = new Histogram("PhiVsPosnNew",HIST_2D_INT,
        TWO_D_CHANNELS,"Phi vs. Corrected Position, gated on PID", 
        "New Position", "Phi");
        ...
        dp_XTheta=new DataParameter("(X|Theta)    ");
        dp_XTheta2=new DataParameter("(X|Theta^2)  ");
        dp_XTheta3=new DataParameter("(X|Theta^3) ");
        ...
        dp_XThetaDelta=new DataParameter("(X|ThetaDelta)");
        dp_XTheta2Delta=new DataParameter("(X|Theta2Delta)");
        dp_XTheta3Delta=new DataParameter("(X|Theta3Delta)");
        dp_XThetaDelta2=new DataParameter("(X|ThetaDelta2)");
        dp_XTheta2Delta2=new DataParameter("(X|Theta2Delta2)");
        dp_XTheta3Delta2=new DataParameter("(X|Theta3Delta2)");
        ...
        for (int i=0; i<NUM_DETECTORS; i++) {
            ...
            for (int j=0; j<STRIPS_PER_DETECTOR; j++) {
                ...
                hTimes[i][j]=new Histogram("T_D"+i+"_S"+j, HIST_1D_INT, ADC_CHANNELS, 
        ...
        "Time vs. Strip, All Detectors, multiplicity one,PID gates", "Time", 
        STRIPS_PER_DETECTOR+"*Det+Strip");*/
        ...
        ,TWO_D_CHANNELS,STRIPS_PER_DETECTOR+1,
        "Strip vs. Energy Deposited","Energy","Strip");
        hStripDecay = new Histogram("Coinc Hits",HIST_1D_INT, STRIPS_PER_DETECTOR,
        "Hits in coincidence w/ state on FP","Strip Number","Counts");
    ...
    int NUM_PEAKS=4;
    int NUM_COEFF=4;
    double [][] correctionTable = new double[NUM_PEAKS][NUM_COEFF];
    private void setupCorrections() throws IOException {
    	FileReader infile = new FileReader("d:/Feb19Ne/coeff2.dat");
    	...
    	System.out.println("Set up corrections table.");
    }
    ...
    private int getCorrectedPosition(int FPchan, int theta){
    	...
    	if (FPchan > correctionTable[NUM_PEAKS-1][0]){
    		System.arraycopy(correctionTable[NUM_PEAKS-1],1,coeffs1,0,NUM_COEFF-1);
    		System.arraycopy(correctionTable[NUM_PEAKS-1],1,coeffs2,0,NUM_COEFF-1); 
    		x1=correctionTable[NUM_PEAKS-1][0];
    		x2=correctionTable[NUM_PEAKS-1][0];
    	}
    	for (int peak = 0; peak<NUM_PEAKS-1; peak++){
    		if  (FPchan > correctionTable[peak][0] && FPchan <= correctionTable[peak+1][0])	{
    			System.arraycopy(correctionTable[peak],1,coeffs1,0,NUM_COEFF-1);
    			System.arraycopy(correctionTable[peak+1],1,coeffs2,0,NUM_COEFF-1); 
    ...
    public void sort(int [] dataEvent) throws Exception {
        ...
        //double XTheta=dp_XTheta.getValue();       //use this to correct the focus for different particle groups with different kinematics
        //double XTheta2=dp_XTheta2.getValue();     //use this to correct the dominant (x|theta^2) split-pole aberration
        //double XTheta3=dp_XTheta3.getValue();     //use this to correct the dominant (x|theta^3) split-pole aberration
        //double XThetaDelta = dp_XThetaDelta.getValue();       // corrects different first-order focus conditions along focal plane
        //double XTheta2Delta = dp_XTheta2Delta.getValue();     // corrects momentum-dependence (x|theta2) term
        //double XTheta3Delta = dp_XTheta3Delta.getValue();     // corrects momentum-dependence of (x|theta3) term
        //double XThetaDelta2 = dp_XThetaDelta2.getValue();       // corrects different first-order focus conditions along focal plane
        //double XTheta2Delta2 = dp_XTheta2Delta2.getValue();     // corrects momentum-dependence (x|theta2) term
        //double XTheta3Delta2 = dp_XTheta3Delta2.getValue();     // corrects momentum-dependence of (x|theta3) term
        ...
        int theta = (int)Math.round(eRPsn - eFPsn - thetaOffset + ADC_CHANNELS/2);
        ...
        int eSntrNew = ADC_CHANNELS/4+(int)Math.round(eSntr-(theta-ADC_CHANNELS/2)/scintThetaSlope);
        int eCthdNew = (int)Math.round(eCthd-(theta_calc)/cathThetaSlope);
        int eAndeNew = (int)Math.round(eAnde-(theta_calc)/andeThetaSlope);     
        /* Calculate correction due to terms in theta (up to 3rd order) and delta
		 * (up to second order) 
        double posnCorrection = -(
        theta_calc*(XTheta + theta_calc * (XTheta2 + theta_calc*XTheta3)) +
        delta*theta_calc*(XThetaDelta + theta_calc*
        (XTheta2Delta + theta_calc*XTheta3Delta)) + 
        delta_sq*theta_calc*(XThetaDelta2 + theta_calc*
        (XTheta2Delta2 + theta_calc*XTheta3Delta2)));
        int ePosnNew = (int)Math.round(eFPsn + posnCorrection);*/
        ...
        int c_theta = theta >> TWO_D_FACTOR;
        int c_phi = phi >> TWO_D_FACTOR;
        ...
        boolean bTP = gThetaVsPsnCorr.inGate(ecPosnNew,c_theta);
        
        boolean bPID = bSCn && bFCn && bFSn && bCAn && bAFn && bASn && bYP;
        boolean bFR = gFrntRear.inGate(ecFPsn,ecRPsn) && !gFRexclude.inGate(ecFPsn,ecRPsn);
        boolean bAlmostGood = bPID && bFR && bYP;
        boolean bGood = bAlmostGood &&  bTP;
        boolean bState = bGood && gPeak.inGate(ePosnNew);
        
        if (bRYvsFY){
            CathTheta.inc(ecCthd, c_theta);
            ScintTheta.inc(ecSntr, c_theta);
            AndeTheta.inc(ecAnde, c_theta);
            PosnTheta.inc(ecFPsn, c_theta);
            CathPhi.inc(ecCthd, c_phi);
            ScintPhi.inc(ecSntr, c_phi);
            AndePhi.inc(ecAnde, c_phi);
            ...
            if (bFCn) hCathNewVsScintNew_gFC.inc(ecSntrNew,ecCthdNew);
            if (bFSn) hCathNewVsScintNew_gFS.inc(ecSntrNew,ecCthdNew);
            if (bFCn && bFSn && bSCn) {
            ...
            for (int j=0; j<STRIPS_PER_DETECTOR; j++) {
                ...
                if (time && energy) {
                    ...
                    if (bTimeBroad) {
                        ...
                        try {
                            double eCMchannel= getEcmChannel(eEnergies[i][j],i,j,eFPsn);
                            hEcmVsStripBroad.inc((int)Math.round(eCMchannel*10),j);//1000 ch, 100 MeV F.S.
                            hEcmVsFP.inc(ecPosnNew,(int)Math.round(eCMchannel));//100 ch, 100 MeV f.s.
                            hEsilVsFP.inc(ecPosnNew,(int)Math.round(ac.getEnergyDeposited(i,j,eEnergies[i][j])*10));
        ...
        if (bPID) {// gated on all 3 gate above
            ...
            if(bGood) {
                ...
                hThetaVsFrontGPID.inc(eFPsn>>2,theta>>2);                
				hThetaVsFront_corr.inc(ecPosnNew, c_theta);                
				hPhiVsFrontGPID.inc(ecFPsn, c_phi);
                hPhiVsFront_corr.inc(ecPosnNew, c_phi);
            }
        }
    }
    ...
    /**
     * Returns cm energy in MeV
     */
    private double getEcmChannel(int eChannelRaw, int det, 
    int strip, int FPchannel)
    throws MathException {
    	double qbr8754 = 2049.027; double ch8754=1110.0;
    	double qbr1246 = 2401.875; double ch1246=2551.5;
    	double slope = (qbr1246-qbr8754)/(ch1246-ch8754);
        double qbr=qbr8754+slope*(FPchannel-ch8754);
        ...
        double [] plab = Boost.make4Momentum(Tlab,mAlpha,ac.getTheta(strip),
        ac.getPhi(det));
