...
static final int [] TDC_BASE = {0x30000000,0x30010000,0x30020000};
    ...
    public void initialize() throws Exception {
        ...
        idCthd=vmeMap.eventParameter(0, ADC_BASE[0], 10, 0);
        idAnde=vmeMap.eventParameter(1, ADC_BASE[0], 1, 0);
        idScintR=vmeMap.eventParameter(2, ADC_BASE[0], 2, 0);
        idScintL=vmeMap.eventParameter(3, ADC_BASE[0], 3, 0);
        idFrntPsn=vmeMap.eventParameter(4, ADC_BASE[0], 4, 0);
        idRearPsn=vmeMap.eventParameter(5, ADC_BASE[0], 5, 0);
        idFrntHgh=vmeMap.eventParameter(6, ADC_BASE[0], 6, 0);
        idRearHgh=vmeMap.eventParameter(7, ADC_BASE[0], 7, 0);
        idYFrnt=vmeMap.eventParameter(8, ADC_BASE[0], 8, 0);
        idYRear=vmeMap.eventParameter(9, ADC_BASE[0], 9, 0);
