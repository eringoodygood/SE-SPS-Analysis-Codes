/*
 */
package sort.coinc.july02;
import java.io.*;
import jam.data.*;
import jam.sort.*;
import dwvisser.analysis.*;
 ...
 * @since 26 July 2001
 */
public class FPplusYLSA_new_2 extends SortRoutine {
    //VME properties
...
static final int [] TDC_BASE = {0x30000000,0x30010000,0x30020000};
    ...
    final int COMPRESS_FACTOR=Math.round((float)(Math.log(ADC_CHANNELS/(2*COMPRESSED_CHANNELS))/Math.log(2.0)));
    final int TWO_D_FACTOR=Math.round((float)(Math.log(ADC_CHANNELS/(2*TWO_D_CHANNELS))/Math.log(2.0)));
    ...
    Histogram hEsilVsFP;
    Histogram hRYvsFY;
    Histogram hEsilVsFPgs; //EsilVsFP gated on ground state band
    Histogram hEsilVsFPms; //gated on metastable state
    Histogram hEsilVsFPsecond; //gated on second excited state 
    Histogram hgroundstate_g1, hgroundstate_g2, hgroundstate_g3;
    Histogram hmetastable_g1, hmetastable_g2, hmetastable_g3, hmetastable_g4, hmetastable_g5, hmetastable_g6;
    Histogram hsecondexcited_g1, hsecondexcited_g2, hsecondexcited_g3;
    Gate gEsilVsFPgs, gEsilVsFPms, gEsilVsFPsecond;
    Gate ggroundstate_g1, ggroundstate_g2, ggroundstate_g3;
    Gate gmetastable_g1, gmetastable_g2, gmetastable_g3, gmetastable_g4, gmetastable_g5, gmetastable_g6;
    Gate gsecondexcited_g1, gsecondexcited_g2, gsecondexcited_g3;
    ...
    public void initialize() throws Exception {
        ...
        idFrontBias = vmeMap.eventParameter(2, ADC_BASE[0], 11, 0);
        idRearBias = vmeMap.eventParameter(2, ADC_BASE[0], 12, 0);
        ...
        hCthdAnde   =new Histogram("CathodeAnode  ", HIST_2D_INT,  1024, "Cathode vs Anode ","Cathode","Anode");
        hSntrCthd   =new Histogram("ScintCathode  ", HIST_2D_INT,  1024, "Cathode vs Scintillator","Scintillator","Cathode");
        hFrntCthd   =new Histogram("FrontCathode  ", HIST_2D_INT,  1024, "Cathode vs Front Position","Front Position","Cathode");
        hFrntAnde   =new Histogram("FrontAnode  ", HIST_2D_INT,  TWO_D_CHANNELS, "Anode vs Front Position","Front Position","Anode");
        hFrntSntr   =new Histogram("FrontScint ", HIST_2D_INT,  1024, "Scintillator vs Front Position","Front Position","Scintillator");
        hFrntPRearP =new Histogram("FrontRear  ", HIST_2D_INT,  1024, "Rear Position vs Front Position","Front Position","Rear Position");
        hFRhires =new Histogram("FRhires  ", HIST_2D_INT,  TWO_D_HIRES, "Rear Position vs Front Position (hires)--gated on PID","Front Position","Rear Position");
        ...
        hFrntGTime_noE  = new Histogram("FrontGTime_noE", HIST_1D_INT, ADC_CHANNELS, "Front Position - ScCa,FwCa,FwSc,FwRw & time gates, no \"energy condition\"");
        ...
        hFrontBias = new Histogram("FrontBias", HIST_1D_INT, ADC_CHANNELS, "Front Wire Bias", "~Volts", "Counts");
        hRearBias = new Histogram("RearBias", HIST_1D_INT, ADC_CHANNELS, "Rear Wire Bias", "~Volts", "Counts");
       ...
       for (int i=0; i<NUM_DETECTORS; i++) {
        ...
        hEsilVsFP = new Histogram("EsilVsFP",HIST_2D_INT,500,250,
        "E (YLSA) vs. Focal Plane Position","QBrho [channels]","E [MeV] * 10");
        hEsilVsFPgs = new Histogram("EsilVsFPgs", HIST_2D_INT,500,250,
        "E (YLSA) Vs. Focal Plane Position ground state","QBroh [channels]","E[MeV] * 10");
		hEsilVsFPms = new Histogram("EsilVsFPms", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position metastable state","QBroh [channels]","E[MeV] * 10");
		hEsilVsFPsecond = new Histogram("EsilVsFPsecond", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position second exicted state","QBroh [channels]","E[MeV] * 10");
        hgroundstate_g1 = new Histogram("EsilVsFP gs_g1", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position groud state, group 1","QBroh [channels]","E[MeV] * 10");
		hgroundstate_g2 = new Histogram("EsilVsFP gs_g2", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position groud state, group 2","QBroh [channels]","E[MeV] * 10");
		hgroundstate_g3 = new Histogram("EsilVsFP gs_g3", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position groud state, group 3","QBroh [channels]","E[MeV] * 10");
		hmetastable_g1 = new Histogram("EsilVsFP ms_g1", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position metastable state, group 1","QBroh [channels]","E[MeV] * 10");
		hmetastable_g2 = new Histogram("EsilVsFP ms_g2", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position metastable state, group 2","QBroh [channels]","E[MeV] * 10");
		hmetastable_g3 = new Histogram("EsilVsFP ms_g3", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position metastable state, group 3","QBroh [channels]","E[MeV] * 10");
		hmetastable_g4 = new Histogram("EsilVsFP ms_g4", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position metastable state, group 4","QBroh [channels]","E[MeV] * 10");
		hmetastable_g5 = new Histogram("EsilVsFP ms_g5", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position metastable state, group 5","QBroh [channels]","E[MeV] * 10");
		hmetastable_g6 = new Histogram("EsilVsFP ms_g6", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position metastable state, group 6","QBroh [channels]","E[MeV] * 10");
		hsecondexcited_g1 = new Histogram("EsilVsFP se_g1", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position second excited state, group 1","QBroh [channels]","E[MeV] * 10");
		hsecondexcited_g2 = new Histogram("EsilVsFP se_g2", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position second excited state, group 2","QBroh [channels]","E[MeV] * 10");
		hsecondexcited_g3 = new Histogram("EsilVsFP se_g3", HIST_2D_INT,500,250,
		"E (YLSA) Vs. Focal Plane Position second excited state, group 3","QBroh [channels]","E[MeV] * 10");
        ...
        gEsilVsFPgs =new Gate("gs band", hEsilVsFP);	//gate ground state on EsilVsFP
		gEsilVsFPms =new Gate("ms band", hEsilVsFP);
		gEsilVsFPsecond =new Gate("second band", hEsilVsFP);
		ggroundstate_g1 =new Gate("gs group 1", hEsilVsFPgs);
		ggroundstate_g2 =new Gate("gs group 2", hEsilVsFPgs);
		ggroundstate_g3 =new Gate("gs group 3", hEsilVsFPgs);
		gmetastable_g1 =new Gate("ms group 1", hEsilVsFPms);
		gmetastable_g2 =new Gate("ms group 2", hEsilVsFPms);
		gmetastable_g3 =new Gate("ms group 3", hEsilVsFPms);
		gmetastable_g4 =new Gate("ms group 4", hEsilVsFPms);
		gmetastable_g5 =new Gate("ms group 5", hEsilVsFPms);
		gmetastable_g6 =new Gate("ms group 6", hEsilVsFPms);
		gsecondexcited_g1 =new Gate("second group 1", hEsilVsFPsecond);
		gsecondexcited_g2 =new Gate("second group 2", hEsilVsFPsecond);
		gsecondexcited_g3 =new Gate("second group 3", hEsilVsFPsecond);
        ...
        hEsilVsFPgs.addGate(gEsilVsFPgs);
		hEsilVsFPms.addGate(gEsilVsFPms);
		hEsilVsFPsecond.addGate(gEsilVsFPsecond);
    ...
    int thetaOffset=358;//taken from June offline analysis parameters
    ...
    public void sort(int [] dataEvent) throws Exception {
        ...
        hFrontBias.inc(dataEvent[idFrontBias]);
        hRearBias.inc(dataEvent[idRearBias]);
            ...
            for (int j=0; j<STRIPS_PER_DETECTOR; j++) {
                ...
                if (time && energy) {
                    ...
                    if (bPID) {
                    	...
                    	hEsilVsFP.inc(ecPosnNew,_Senergy);
                    	boolean bGS =gEsilVsFPgs.inGate(ecPosnNew,_Senergy);
						boolean bMS =gEsilVsFPms.inGate(ecPosnNew,_Senergy);
						boolean bSECOND =gEsilVsFPsecond.inGate(ecPosnNew,_Senergy);
						if (bGS) {
							hEsilVsFPgs.inc(ecPosnNew,_Senergy);
							boolean bGS_G1 =ggroundstate_g1.inGate(ecPosnNew,_Senergy);
							boolean bGS_G2 =ggroundstate_g2.inGate(ecPosnNew,_Senergy);
							boolean bGS_G3 =ggroundstate_g3.inGate(ecPosnNew,_Senergy);
							if (bGS_G1) {
								hgroundstate_g1.inc(ecPosnNew,_Senergy);
							}
							if (bGS_G2) {
							
								hgroundstate_g2.inc(ecPosnNew,_Senergy);
							}
							if (bGS_G3) {
							
								hgroundstate_g3.inc(ecPosnNew,_Senergy);
							}
						}
						if (bMS) {
							hEsilVsFPms.inc(ecPosnNew,_Senergy);
							boolean bMS_G1 =gmetastable_g1.inGate(ecPosnNew,_Senergy);
							boolean bMS_G2 =gmetastable_g2.inGate(ecPosnNew,_Senergy);
							boolean bMS_G3 =gmetastable_g3.inGate(ecPosnNew,_Senergy);
							boolean bMS_G4 =gmetastable_g4.inGate(ecPosnNew,_Senergy);
							boolean bMS_G5 =gmetastable_g5.inGate(ecPosnNew,_Senergy);
							boolean bMS_G6 =gmetastable_g6.inGate(ecPosnNew,_Senergy);
							if (bMS_G1) {
								hmetastable_g1.inc(ecPosnNew,_Senergy);
														}
							if (bMS_G2) {
								hmetastable_g2.inc(ecPosnNew,_Senergy);
																					}
							if (bMS_G3) {
								hmetastable_g3.inc(ecPosnNew,_Senergy);
																					}
							if (bMS_G4) {
								hmetastable_g4.inc(ecPosnNew,_Senergy);
																					}
							if (bMS_G5) {
								hmetastable_g5.inc(ecPosnNew,_Senergy);
																					}
							if (bMS_G6) {
								hmetastable_g6.inc(ecPosnNew,_Senergy);
																					}
						}
						if (bSECOND) {
							hEsilVsFPsecond.inc(ecPosnNew,_Senergy);
							boolean bSECOND_G1 =gsecondexcited_g1.inGate(ecPosnNew,_Senergy);
							boolean bSECOND_G2 =gsecondexcited_g2.inGate(ecPosnNew,_Senergy);
							boolean bSECOND_G3 =gsecondexcited_g3.inGate(ecPosnNew,_Senergy);
							if (bSECOND_G1) {
								hsecondexcited_g1.inc(ecPosnNew,_Senergy);
																					}
							if (bSECOND_G2) {
								hsecondexcited_g2.inc(ecPosnNew,_Senergy);
																												}
							if (bSECOND_G3) {
								hsecondexcited_g3.inc(ecPosnNew,_Senergy);
																												}
						}
                    }
                    if (bTimeBroad) {
                        ...
                        int _Senergy = (int)Math.round(ac.getEnergyDeposited(i,j,eEnergies[i][j])*10);                    	
                        if (multiplicity==1){
                        	hEsilVsFP_m1.inc(ecPosnNew,_Senergy);
                        } else if (multiplicity==2){
                        	hEsilVsFP_m2.inc(ecPosnNew,_Senergy);
                        } else if (multiplicity==3) {
                        	hEsilVsFP_m3.inc(ecPosnNew,_Senergy);
                        }
	    ...
	    hFRhires.inc(eFPsn>>(TWO_D_HR_FACTOR-1),eRPsn>>(TWO_D_HR_FACTOR-1));
            if(bGood) {
                writeEvent(dataEvent);
                hFrntGAll.inc(eFPsn);
                hRearGAll.inc(eRPsn);
