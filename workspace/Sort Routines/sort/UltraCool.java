...
/*
 * Sort file for ultra detector cooling tests offline analysis, modified from SplitPoleVMEbeta1
 *
 *  convention for 2 d Histograms x first then y (x vs y)
 *
 * Author Ken Swartz, Alan Chen, and Dale Visser
 * last modified November 2000 by Rachel Lewis
 */
public class UltraCool extends SortRoutine {
