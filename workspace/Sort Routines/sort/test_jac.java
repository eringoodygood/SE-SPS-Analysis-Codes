 ...
 */
public class test_jac extends SortRoutine {
	...
	hFrntThta   =new Histogram("FrontTheta  ", HIST_2D,  256, " Front Position vs Theta ", "front position", "theta");
