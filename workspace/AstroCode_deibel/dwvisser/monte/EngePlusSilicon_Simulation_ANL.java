 ...
 * @version 1.0
 * 
 * revised by C.M. Deibel March 2010 to be used with ANL Enge and DSSD
 */
public class EngePlusSilicon_Simulation_ANL extends Object {
	static final double C_MM_PER_NSEC = 299.792458;
	static final double DEAD_LAYER_THICKNESS = 0.0; //um
	...
	public EngePlusSilicon_Simulation_ANL() {
		...
		double thetaYLSA = 0; //angle of array detectors
		try {
