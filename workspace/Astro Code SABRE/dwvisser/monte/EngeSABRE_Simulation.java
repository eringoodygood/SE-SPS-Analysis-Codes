 ...
 * @version 1.0
 */
public class EngeSABRE_Simulation extends Object {
	...
	public EngeSABRE_Simulation() {
		DataSet[] stripCMtheta = new DataSet[16];

		double[] ExResidValues = {2.365}; //value of state populated in excited nucleus BEFORE decay into sabre: MeV
		...
		xtarg = 20.0; //thickness in ug/cm^2
		String starg = "C 1"; //material specification for target: THE STOICH
		theta = 3; //for spectrometer, in degrees
		...
		for (int rEx = 0; rEx < ExResidValues.length; rEx++) {
			...
			String outFileRoot =
			      ...
			      "/Users/goode/Desktop/SPS_code/mcSims/2022_lit_vals/"
					//+ "Ex_7.8_slit_val_"
			     // + thetaAcceptance;
