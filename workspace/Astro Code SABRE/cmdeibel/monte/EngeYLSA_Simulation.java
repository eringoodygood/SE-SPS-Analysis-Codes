	...
	public EngeYLSA_Simulation() {
		...
		for (int rEx = 0; rEx < ExResidValues.length; rEx++) {
			...
			String outFileRoot =
			      ...
			      "C:/Documents and Settings/Catherine Deibel/My Documents/26Alm/april07/28Si(3He,4He)/YLSA sims/excited state/jan08/"
