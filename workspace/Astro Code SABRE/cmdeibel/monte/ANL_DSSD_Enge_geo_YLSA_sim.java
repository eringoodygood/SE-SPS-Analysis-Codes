...
public class ANL_DSSD_Enge_geo_YLSA_sim extends Object{
	 ...
	 * */
	public ANL_DSSD_Enge_geo_YLSA_sim() {
		...
		Ebeam = 500; //beam kinetic energy in MeV
		...
		double phiAcceptance = 0.0125; //choose "phi" of projectile <= +/- this
		...
		for (int rEx = 0; rEx < ExResidValues.length; rEx++) {
			...
			do{
				...
				if (hit) {
					ring = md.getRing();
					int bin = ring;
					//double incidence = s2d.getIncidence(); not worrying about this now; 
					//just making constant 15 deg
					
					double incidenceDeg = 15;
	...
	static public void main(String[] args) {
		new ANL_DSSD_Enge_geo_YLSA_sim();
