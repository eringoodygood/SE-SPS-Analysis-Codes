...
public class ANL_DSSD_Enge_sim_3 extends Object{
	...
	public ANL_DSSD_Enge_sim_3() {
		...
		for (int rEx = 0; rEx < ExResidValues.length; rEx++) {
			...
			//not sure about this whole angle binning thing . .. 
			int angleBinning = 60;
			...
			do{
				...
				//this is now random selection of projectile direction
