...
public class ANL_DSSD_Enge_sim_LE_branch extends Object{
	 ...
	 * */
	public ANL_DSSD_Enge_sim_LE_branch() {
		...
		for (int rEx = 0; rEx < ExResidValues.length; rEx++) {
			...
			do{
				...
				double ELabResid = reaction.getLabEnergyResidual(0);
				...
				p_lab[0] = ELabResid;
				System.arraycopy(
						residDir.get3vector(reaction.getLabMomentumResidual(0)),
						0,
						p_lab,
						1,
						3);
				...
				if (hit) {
					...
					//double Tinit = p_lab[0] - Mresid; in original code p_lab[0] came from boost to p_cm
	...
	static public void main(String[] args) {
		new ANL_DSSD_Enge_sim_LE_branch();
