...
public class NukeSimLauncher extends JFrame {
	...
	private NukeSimLauncher() {
		...
		Icon tempIcon =
			new ImageIcon(loader.getResource("dwvisser/jrelkin96.png"));
		JButton tempButton = new JButton(tempIcon);
		tempButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dwvisser.JRelKin.main(noArgs);
			}
		});
		labelPanel.add(new JLabel("JRelKin", JLabel.RIGHT));
		;
		buttonPanel.add(tempButton);
		tempIcon = new ImageIcon(loader.getResource("dwvisser/plotter96.png"));
		tempButton = new JButton(tempIcon);
		tempButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dwvisser.SpecPlot.main(noArgs);
			}
		});
		labelPanel.add(new JLabel("Focal Plane Plotter", JLabel.RIGHT));
		;
		buttonPanel.add(tempButton);
		tempIcon = new ImageIcon(loader.getResource("dwvisser/spanc96.png"));
		tempButton = new JButton(tempIcon);
		tempButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dwvisser.Spanc.main(noArgs);
			}
		});
		labelPanel.add(
			new JLabel("Spanc--SPlitpole ANalysis Code", JLabel.RIGHT));
		;
		buttonPanel.add(tempButton);
