...
public class EngeSABRE_Simulation extends Object {
	...
	public EngeSABRE_Simulation() {
		...
		double[] ExResidValues = {8};//{8.3497, 8.4397, 8.4754, 8.5553, 8.659, 8.8661, 9.0176};//, 9.134, 9.163, 9.2135, 9.2713, 9.3641, 9.428, 9.5456, 9.6155, 9.652, 9.7141, 9.9177, 10.008, 10.0383, 10.0824, 10.235, 10.36, 10.425};//m.s.8.1558, 8.3117, 8.3684, 8.4397, 8.5815, 8.7755, 8.871, 8.9733, 9.065, 9.255, 9.3182, 9.3538, 9.428, 9.5456, 9.7141, 9.7905, 9.8947, 10.008, 10.0648, 10.235};// g.s. 8.1558, 8.2082, 8.3497, 8.52, 8.5553, 8.659, 8.8205, 8.925, 9.0176, 9.053, 9.087, 9.134, 9.2329, 9.29, 9.343, 9.3641, 9.411, 9.456, 9.5745, 9.6155, 9.7666, 10.1084, 10.214, 10.36, 10.425};//8.036, /*8.165, 8.176, 8.184, 8.232, 8.289, 8.328, 8.374, 8.358, 8.451, 8.514, 8.545, 8.556, 8.573, 8.597, 8.671, 8.719, 8.777, 8.871, 8.994, */ };
		...
		Ebeam = 17.5; //beam kinetic energy in MeV
		xtarg = 56; //thickness in ug/cm^2
		String starg = "Al 1"; //material specification for target
		theta = 0; //for spectrometer, in degrees
		double thetaAcceptance = 0.010;
		...
		for (int rEx = 0; rEx < ExResidValues.length; rEx++) {
			...
			String outFileRoot =
			      ...
			      "/Users/catherinemdeibel/Documents/Monte Carlo/SABRE/"
