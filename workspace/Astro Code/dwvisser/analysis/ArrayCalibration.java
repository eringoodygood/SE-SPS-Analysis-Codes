...
import java.io.*;
import dwvisser.NumericTextFileReader;
...
public class ArrayCalibration extends Object implements Serializable {
    ...
    /**
     * Gets the offsets from a text file. The format of the file is<br>
    ...
    /** 
     * Returns 1/cos(incident angle) for a ray from the target to a 
     * particular strip.  What it actually returns is the average 
     * value taken from a ~1 million event Monte Carlo.
     * 
    ...
    public static void main (String [] args) {
        ...
        try {
            ac.getOffsets(new File(
            "/test.dat")); 
           //"/data/may01/analysis/May2001CorrectedOffsets.dat"));
            ObjectOutputStream oos=new ObjectOutputStream(new
            FileOutputStream(new File("/ArrayCalibration.obj")));
            oos.writeObject(ac);
            oos.close();
        } catch (IOException e) {
